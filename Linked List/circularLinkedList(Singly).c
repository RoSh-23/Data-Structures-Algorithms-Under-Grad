/*** Program to implement a circular singly linked list ***/
#include <stdio.h>
#include <stdlib.h>
#define TRUE 1
#define FALSE 0
...
int main()
{
    ...
    {
        system("cls");
        printf("Program to perform operations on a circular singly linked list\n");
...
int delete(int position)
{
    ...
    if(position == 1)
    {
    ...
    else if(position == count)
        {
            ...
            lastPtr = start;
            while(lastPtr->NEXT != start)
            {
                lastPrevPtr = lastPtr;
                lastPtr = lastPtr->NEXT;
            }
            deletedInfo = lastPtr->info;
            lastPrevPtr->NEXT = start;
            free(lastPtr);
