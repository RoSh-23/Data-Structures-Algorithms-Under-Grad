/*** Program to count the number of nodes in a linked list - focus on elementCount function ***/
#include <stdio.h>
#include <stdlib.h>
#define TRUE 1
#define FALSE 0
...
int main()
{
    ...
    do
    {
        ...
        switch(choice)
        {
            ...
            case 4:
            {
                int noOfNodes = elementCount();
		printf("%d is the number of nodes in the list currently\n", noOfNodes);
                break;
            }
            case 5:
            {
