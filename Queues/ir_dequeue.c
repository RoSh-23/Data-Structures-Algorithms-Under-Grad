/*Program to implement input restricted deque*/
#include <stdio.h>
#include <conio.h>
#include <stdlib.h>
...
int main()
{
    ...
    {
        //system("cls");
        printf("Program to perform operations on a input restricted dequeue\n");
        printf("  Press 1: To insert an item in the queue\n  Press 2: To delete an item from front of the queue\n  Press 3: To delete an item from the back of the queue\n  Press 4: To check wether the queue is empty\n  Press 5:To traverse through the queue\n");
        scanf("%d", &option);
